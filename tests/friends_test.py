...
class TestFriends(unittest.TestCase):
    def setUp(self):
        self.person1 = {
            ...
            "favourites": {"tv_show": "Friends", "snacks": ["charcuterie"]},
        }
        ...
        self.person2 = {
            ...
            "monies": 2,
            "friends": ["Fred"],
            "favourites": {"tv_show": "Baywatch", "snacks": ["soup", "bread"]},
        }
        ...
        self.person3 = {
            ...
            "favourites": {"tv_show": "Pokemon", "snacks": ["Scooby snacks"]},
        }
        ...
        self.person5 = {
            ...
            "monies": 100,
            "friends": [],
            "favourites": {"tv_show": "X-Files", "snacks": ["spinach"]},
        }
